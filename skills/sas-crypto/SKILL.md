---
name: sas-crypto
description: SAS-FAS v4.0 加密资产分析 Skill。整理代币供给、收益、合规与合约控制权相关指标。
---
...
1. **代币经济学矩阵 (Tokenomics)**：
   - **抛压冲击因子**：月度解锁量 (USD) ÷ 日均交易量。若比值 > 0.3，标记潜在供给压力。
   - **激励调整后收益**：协议名义收益 (Revenue) - 代币增发激励支出 (Incentives) = 真实收益 (Real Yield)。若真实收益持续为负，标记为激励依赖。
